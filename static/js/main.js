...
var words_list = ["INHERITANCE","POLYMORPHISM","ENCAPSULATION","ABSTRACTION","VIRTUAL","OBJECT","CLASS","FUNCTION","NAMESPACE","TEMPLATE","VARIABLES"];
			...
			if (mouseMoved) {
				...
				if (checkWord()) {
					...
					if(isEndOfGame()) {
						...
						//console.log(min);
						sec = sec % 60;
						$(".result").append("<span id='time'>Time required:"+ min +" minutes "+ sec +" seconds</span>");
					}
				}
